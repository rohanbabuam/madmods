...
<script lang="ts">
    ...
    function createScene(canvas: HTMLCanvasElement) {
        ...
        // Sky color
        babylonScene.clearColor = new Color4(0.7, 0.85, 1.0, 1.0); // Light blue sky
        ...
        gridMaterial.lineColor = new Color3(0.21, 0.25, 0.75);
    ...
    async function loadModelIntoScene(propState: PropState, scene: Scene) {
        ...
        try {
            ...
            if (result.meshes.length > 0) {
                ...
                var halfHeight = rootMesh.getBoundingInfo().boundingBox.extendSizeWorld.y;
